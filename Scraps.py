...
class Parser:
    ...
    def data_parse(self,x, soup,job):
        ...
        :param jobs: a list of jobs will be passed to determine which one has the most amount of jobs possible.
...
# main controller module that manages all the other modules in the  script
def main(jobs):
